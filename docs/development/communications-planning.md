...
#### Target Commands:
- **`/create-account`** - Welcome new players publicly
...
|---------|----------------|-------------------|----------------------|
| **Account Management** |
| `/create-account` | Private | **Public welcome message** | HIGH ⭐ |
| `/delete-account` | Private | **Stay Private** | - |
...
- [ ] Modify `/create-account` to announce new players
